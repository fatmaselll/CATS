...
function botCevapla(input) {
  ...
  // KAVURMA özel cevabı
  if (normalize(input).includes("kavurma")) {
    return "Beni kavurma olarak görmen etik değil ama çok istiyorsan seni kavurma yapayım 😼 Benim hem 9 canım var, senin sadece 1! Hahahahaha";
  }
